...
use App\Filament\Resources\RealEstateCompanyResource\Pages\CreateRealEstateCompany;
use App\Filament\Resources\RealEstateCompanyResource\Pages\EditRealEstateCompany;
use App\Filament\Resources\RealEstateCompanyResource\Pages\ListRealEstateCompanies;
...
class RealEstateCompanyResource extends Resource
{
    ...
    public static function getLabel(): ?string
     {
         return __('Real Estate Companies');
     }
    ...
    {
        return parent::getEloquentQuery()->withoutGlobalScopes()->where('type', 'real_estate_companies');
    }
    ...
    {
        return [
            'index' => ListRealEstateCompanies::route('/'),
            'create' => CreateRealEstateCompany::route('/create'),
            'edit' => EditRealEstateCompany::route('/{record}/edit'),
        ];
    }
}
